...
export default function App() {
  ...
  return (
    ...
    <div
      ...
      data-chat-fullscreen={isDesktopEmbedRoute ? "true" : "false"}
      className={cn(
        "flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden antialiased",
        isDesktopEmbedRoute
          ? "bg-[#fcfcfe] text-[#1e2033]"
    ...
    >
      ...
      <header
        className={cn(
          ...
          "bg-background-base",
          // Desktop embed owns chrome — hide dashboard mobile header.
          isDesktopEmbedRoute && "hidden",
        )}
        style={{
      ...
      <div
        className={cn(
          ...
          isDesktopEmbedRoute ? "pt-0" : "pt-14 lg:pt-0",
        )}
      >
        <div className="flex min-h-0 min-w-0 flex-1">
          <aside
            ...
            className={cn(
              ...
              collapsed && "lg:w-14",
              // Fullscreen desktop shell — no dashboard sidebar chrome.
              isDesktopEmbedRoute && "hidden",
            )}
            style={{
          ...
          <PageHeaderProvider pluginTabs={pluginTabMeta}>
            <div
              className={cn(
                ...
                (isDocsRoute || isDesktopEmbedRoute) && "min-h-0 flex-1",
              )}
            >
              ...
              <div
                className={cn(
                  ...
                  (isDocsRoute || isDesktopEmbedRoute) &&
              ...
              >
                ...
                {hermesOne &&
                  ...
                  (pluginsLoading ? (
                    ...
                    <div
                      data-chat-active={isDesktopEmbedRoute ? "true" : "false"}
                      className={cn(
                        "min-h-0 min-w-0",
                        isDesktopEmbedRoute ? "flex flex-1 flex-col" : "hidden",
                      )}
                      aria-hidden={!isDesktopEmbedRoute}
                    >
                      <Suspense
                        fallback={
                          isDesktopEmbedRoute ? (
