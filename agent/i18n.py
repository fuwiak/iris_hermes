...
Usage::
    ...
    print(t("approval.choose_long", lang="ru"))            # explicit override
...
def _normalize_lang(value: Any) -> str:
    ...
    and case-insensitive regional tags (``ru-RU`` -> ``ru``).  Returns the
    ...
    # Try stripping a region suffix (e.g. "de-DE" -> "de" won't be supported,
    # but "ru-RU" -> "ru" will).
    base = key.split("-", 1)[0]
