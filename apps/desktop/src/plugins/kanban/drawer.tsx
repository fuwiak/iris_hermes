...
export function TaskDrawer({
  ...
  return (
    <div className="absolute inset-y-0 right-0 z-20 flex w-[26rem] flex-col border-l border-[#e8eaf0] bg-white text-[#1e2033] duration-150 ease-out animate-in fade-in slide-in-from-right-4">
