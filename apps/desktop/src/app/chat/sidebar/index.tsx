...
export function ChatSidebar({
  ...
  const navLabel = (item: SidebarNavItem) => {
    const labels: Record<string, string> = {
      ...
      messaging: s.hermesOneNav.office,
      artifacts: s.hermesOneNav.kanban,
      schedules: s.hermesOneNav.schedules
    }
          ...
          <SidebarGroupContent>
            <SidebarMenu className="gap-px">
              {[...primaryNav, ...contributedNav].map(item => {
                const isInteractive = Boolean(item.action) || Boolean(item.route) || Boolean(item.onSelect)
                  ...
                  <SidebarMenuButton
                    ...
                    tooltip={
                      item.keybindActionId
                        ? {
                            children: <TipKeybindLabel actionId={item.keybindActionId} text={navLabel(item)} />
                          }
                        : navLabel(item)
                    }
                    type="button"
