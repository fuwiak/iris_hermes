...
export function SkillsView(props: SkillsViewProps) {
  ...
  // Hermes One: Discover marketplace is the product surface for /skills.
  if (hermesOneWeb) {
...
function CapabilitiesView({ setStatusbarItemGroup: _setStatusbarItemGroup, ...props }: SkillsViewProps) {
  const { t } = useI18n()
