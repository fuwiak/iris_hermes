...
export const en: Translations = {
  ...
  skills: {
    ...
    discover: {
      ...
      emptySkillsTitle: 'No skills to show',
      emptyMcpsTitle: 'No MCP servers in catalog',
      emptyAgentsTitle: 'Agents coming soon',
  ...
  composer: {
    hermesOneIntro: {
      ...
      sampleUserTime: 'Today, 11:42',
      sampleAnswer: 'The most profitable channel in July was your own website.',
      sampleAiTime: 'Today, 11:43',
      insightTitle: 'Own website — profit leader',
      insightSub: 'Revenue: 824,000 ₽  |  Margin: 38%',
      recTitle: 'Recommendation',
      recBody:
        'Raise repeat customers on the site to 35%. That can grow profit without increasing the ad budget.',
      chartTitle: 'Profitability by channel for July',
      showMore: 'Show more',
      download: 'Download',
      chSite: 'Own website',
      chYandex: 'Yandex Flowers',
      chFlowwow: 'Flowwow',
      chOffline: 'Offline store',
      chSocial: 'Social & messengers',
      examplesTitle: 'Example prompts',
      exMargin: 'Which products have the highest margin?',
      exMarginPrompt: 'Which products have the highest margin?',
      exWriteoffs: 'Where are the biggest write-offs this month?',
      exWriteoffsPrompt: 'Where are the biggest write-offs this month?',
      exCall: 'Which clients should I call today?',
      exCallPrompt: 'Which clients should I call today?',
      exCompare: 'Compare July and June revenue',
      exComparePrompt: 'Compare July and June revenue',
      exAds: 'Which ads pay off best?',
      exAdsPrompt: 'Which ads pay off best?',
      tipTitle: 'AI tip',
      tipBody:
        'Ask about sales, clients, finance, warehouse, and marketing — Iris AI answers from your CRM data.',
      sourcesTitle: 'Data sources',
      srcOrders: 'Orders',
      srcCatalog: 'Catalog',
      srcFinance: 'Finance',
      srcWarehouse: 'Warehouse',
      srcMarketing: 'Marketing',
      srcReviews: 'Reviews',
      sourcesUpdated: 'Data updated Today, 11:30',
      refresh: 'Refresh',
      searchWeb: 'Which products have the highest margin?',
      searchWebPrompt: 'Which products have the highest margin?',
      reminder: 'Where are the biggest write-offs this month?',
      reminderPrompt: 'Where are the biggest write-offs this month?',
      emails: 'Which clients should I call today?',
      emailsPrompt: 'Which clients should I call today?',
      script: 'Compare July and June revenue',
      scriptPrompt: 'Compare July and June revenue',
      cron: 'Which ads pay off best?',
      cronPrompt: 'Which ads pay off best?',
      data: 'Which products bring the most profit?',
      dataPrompt: 'Which products bring the most profit?'
    },
    message: 'Message',
