...
export const ru = defineLocale({
    ...
    settings: {
      ...
      fieldDescriptions: defineFieldCopy({
        ...
        "tts.xai.autoSpeechTags": 'Let an LLM insert expressive audio tags ([laughing], [sighs]) into the script before synthesis.',
        ...
        "updates.nonInteractiveLocalChanges": 'When Hermes updates itself from the app (no terminal prompt), keep local source edits (stash) or throw them away (discard). Terminal updates always ask.',
      }),
      about: {
...
Leave blank to keep the ${mode} default.`,
    ...
    composer: {
      hermesOneIntro: {
        title: 'Чем могу помочь сегодня?',
        subtitle: 'Попросите написать код, ответить на вопросы, найти что-то в интернете и не только',
        searchWeb: 'Поиск в интернете',
        searchWebPrompt: 'Search the web for today\'s most useful updates',
        reminder: 'Напоминание',
        reminderPrompt: 'Помогите мне установить напоминание',
        emails: 'Сводка писем',
        emailsPrompt: 'Summarize the emails that need my attention',
        script: 'Написать скрипт',
        scriptPrompt: 'Помогите мне написать сценарий',
        cron: 'Запланировать cron-задачу',
        cronPrompt: 'Help me schedule a cron job',
        data: 'Анализ данных',
        dataPrompt: 'Помогите мне проанализировать некоторые данные',
      },
      message: 'Сообщение',
