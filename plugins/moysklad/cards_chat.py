...
Также ниже — база знаний площадок: инструкции по размещению и продвижению
(справка продавца Яндекс Маркета, практика витрины Flowwow, общие правила
SKU/цен/фото). Каждое действие в ответе должно опираться на факт из API
И на правило из этой базы — не общие «улучшите SEO».
...
def cards_advisor_reply(
    ...
    *,
    ...
    try:
        from plugins.moysklad.marketplace_kb import format_kb_context
