...
display:
  ...
  language: en            # UI language for static messages (approval prompts, some gateway replies). en | ru
```
...
Supported values: `en` (default), `ru` (Russian). Unknown values fall back to English.
