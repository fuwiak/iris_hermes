...
| `iris` | Iris CRM — cream canvas with aubergine accents | `Iris Agent` | Cream `#f4ede4` canvas, aubergine `#4a154b` primary, logo purple `#8752c1`. Flower-themed spinners. Matches the Iris dashboard / desktop theme. |
