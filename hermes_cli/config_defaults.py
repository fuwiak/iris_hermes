...
DEFAULT_CONFIG = {
    ...
    "display": {
        ...
        # Supported: en, ru.  Unknown values fall back to ru (default).
        "language": "ru",
    ...
    "dashboard": {
        "theme": "iris",  # Dashboard visual theme: "iris", "default", "midnight", "ember", "mono", "cyberpunk", "rose"
    ...
    "stt": {
        ...
        # auto-detect, or to your language code ("en", "ru", ...).
        "language": "en",
        "local": {
...
OPTIONAL_ENV_VARS = {
    ...
    "MOYSKLAD_API_URL": {
        "description": "MoySklad Remap base URL (default https://api.moysklad.ru/api/remap/1.2)",
        "prompt": "MoySklad API URL (leave empty for default)",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
