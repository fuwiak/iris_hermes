...
- ``iris`` — Light B2B SaaS canvas + purple accents (kartochki-tovarov mock)
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    # Iris CRM — light B2B SaaS (kartochki-tovarov mock): canvas #fcfcfe,
    # purple #7137f5 / #8b5cf6, ink #1e2033, border #e8eaf0, green #36c878.
    "iris": {
        "name": "iris",
        "description": "Iris CRM — light B2B SaaS with purple accents",
        "colors": {
            "background": "#fcfcfe",
            "banner_border": "#7137f5",
            "banner_title": "#7137f5",
            ...
            "prompt": "#1e2033",
            "input_rule": "#8b5cf6",
            "response_border": "#7137f5",
            "status_bar_bg": "#ffffff",
            "status_bar_text": "#1e2033",
            "status_bar_strong": "#7137f5",
            "status_bar_dim": "#858ba3",
            "status_bar_good": "#36c878",
            "status_bar_warn": "#ff9e3d",
            "status_bar_bad": "#ff365f",
            "status_bar_critical": "#ff365f",
            "session_label": "#7137f5",
            "session_border": "#e8eaf0",
            "completion_menu_bg": "#ffffff",
            "completion_menu_current_bg": "#f2edff",
            "completion_menu_meta_bg": "#fcfcfe",
            "completion_menu_meta_current_bg": "#f2edff",
            "selection_bg": "#f2edff",
            "shell_dollar": "#7137f5",
