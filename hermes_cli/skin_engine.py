...
- ``iris`` — White floral canvas + violet accents (Iris CRM / crmiris.ru)
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    # Iris CRM — white floral (crmiris.ru): lavender canvas #f6f3fc,
    # violet primary #6e36ca / #b750f3, high-contrast plum ink #1f1438, leaf green #206b22.
    "iris": {
        "name": "iris",
        "description": "Iris CRM — white floral canvas with violet accents",
        "colors": {
            "background": "#f6f3fc",
            "banner_border": "#6e36ca",
            "banner_title": "#6e36ca",
            "banner_accent": "#b750f3",
            "banner_dim": "#3d2a5c",
            "banner_text": "#1f1438",
            "ui_accent": "#6e36ca",
            "ui_label": "#6e36ca",
            ...
            "prompt": "#1f1438",
            "input_rule": "#b750f3",
            "response_border": "#6e36ca",
            "status_bar_bg": "#fbf9fe",
            "status_bar_text": "#1f1438",
            "status_bar_strong": "#6e36ca",
            "status_bar_dim": "#3d2a5c",
            "status_bar_good": "#206b22",
            "status_bar_warn": "#a67c00",
            "status_bar_bad": "#cc4117",
            "status_bar_critical": "#cc4117",
            "session_label": "#6e36ca",
            "session_border": "#c9b8e0",
            "completion_menu_bg": "#ffffff",
            "completion_menu_current_bg": "#efeaf8",
            "completion_menu_meta_bg": "#f6f3fc",
            "completion_menu_meta_current_bg": "#f0e8ff",
            "selection_bg": "#efeaf8",
            "shell_dollar": "#003cde",
            "voice_status_bg": "#fbf9fe",
        },
        "spinner": {
            "waiting_faces": ["(✿)", "(❀)", "(❁)", "(✾)", "(✽)"],
            "thinking_faces": ["(✿)", "(❀)", "(❁)", "(✾)", "(✽)"],
